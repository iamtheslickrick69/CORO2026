...
export function GradientDots({
    ...
    return (
        <motion.div
          ...
          radial-gradient(circle at 50% 50%, transparent 1.5px, ${backgroundColor} 0 ${dotSize}px, transparent ${dotSize}px),
          radial-gradient(circle at 50% 50%, #0066FF, transparent 60%),
          radial-gradient(circle at 50% 50%, #3B82F6, transparent 60%),
          radial-gradient(circle at 50% 50%, #60A5FA, transparent 60%),
          radial-gradient(ellipse at 50% 50%, #0052CC, transparent 60%)
        `,
                backgroundSize: `
